  ...
  return (
    <div className="p-3 md:mx-auto">
      <div className="flex-wrap flex gap-4 justify-center">
        <div className="flex flex-col p-3dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
      ...
      <div className='mt-3 flex flex-wrap gap-4 py-3 mx-auto justify-center'>
                ...
                <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800'>
                  <Table.Cell>
                    <img 
                      src={post.image}
                      alt='user'
                      className='w-14 h-10 roundedmd bg-gray-500'
                    >
                    </img>
                  </Table.Cell>
                  <Table.Cell className='w-96'>
