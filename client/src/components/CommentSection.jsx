      ...
      {currentUser ?
        (
          <div className='flex items-center gap-1 my-5 text-gray-500 text-sm'>
            <p>Signed in as:</p>
            <img className='h-5 w-5 object-contain rounded-full' src={currentUser.profilePicture} alt=""/>
      ...
      {currentUser && (
        <form onSubmit={handleSubmit} className='border border-teal-500 rounded-md p-3 ' >
          ...
          <div className='flex justify-between items-center mt-5'>
            <p className='text-gray-500 text-sx'>{200 - comment.length} characters remining</p>
        ...
        <Modal.Header/>
          <Modal.Body>
            <div className="text-center">
              ...
              <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Are you sure delete this comment?</h3>
